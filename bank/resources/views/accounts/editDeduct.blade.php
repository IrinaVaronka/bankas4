        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    <h3>Deduct Funds</h3>
                    <p>Deduct funds for {{$account->accountClient->name}} {{$account->accountClient->surname}}</p>
                    <form action="{{route('accounts-updateDeduct', $account)}}" method="post">
                        <div class="col-md-12">
                        ...
                        <div class="form-button mt-3">
                            <button id="submit" type="submit" class="btn btn-primary">Deduct</button>
                            @csrf
                            @method('put')
                        </div>
                    </form>
